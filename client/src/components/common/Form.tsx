            ...
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc">
                <form style={{marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px'}}
                    ...
                    <FormControl>
                        ...
                        <TextField fullWidth required id="outline-basic" color="info"
                    ...
                    <FormControl>
                        ...
                        <TextareaAutosize minRows={5} required placeholder="Write Description" color="info" style={{
                            width: '100%',
                    ...
                    <Stack direction="row" gap={4}>
                        ...
                        <FormControl>
                            ...
                            <TextField fullWidth required id="outline-basic" type="number" color="info"
